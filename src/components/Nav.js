    ...
    return (
      <div className="bg-black fixed w-full">
        <div className="max-w-7xl mx-auto flex flex-row justify-around items-center p-2">
              <div className="m-2">
                <Link to="/">
                  <p className="text-2xl md:text-3xl lg:text-4xl text-blue-100 text-center font-mono whitespace-nowrap mx-2">LAMBA</p>
                </Link>
              </div>

              <p className="hidden md:inline  max-w-md text-md lg:text-lg text-white text-center font-mono mx-2">Lamba Electronics Ecommerce</p>
